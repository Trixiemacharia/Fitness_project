...
ONBOARDING_STEPS = [
    ...
    {"field": "equipment", "question": "What equipment do you have access to?", "type": "multi", "choices": [
        ('none','None'),('dumbells','Dumbells'),('resistance_bands','Resistance Bands'),
        ('barbell','Barbell'),('machines','Machines'),
    ]},
...
def onboarding(request):
    ...
    if step >= len(ONBOARDING_STEPS):
        ...
        profile = UserProfile.objects.create(
            ...
            wants_meal_plan=data.get("meal_plan_recommendations") == "Yes",
        )

        request.session.pop("onboarding_data", None)

        # Auto-generate meal plan if they said Yes
